...
async function routes (fastify, options) {
    ...
    fastify.post('/message', (request, reply) => {
        ...
        const onConnect = (err, client, release) => {
            ...
            client.query(
                'INSERT INTO messages (message, image, name, location, twitter, approved) VALUES ($1, $2, $3, $4, $5, false) RETURNING id, image, message, name, location, twitter, approved', [request.body.message, request.body.image, request.body.name, request.body.location, request.body.twitter],
                function onResult (err, result) {
                    release();
